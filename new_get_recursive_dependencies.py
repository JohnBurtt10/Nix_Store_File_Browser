            ...
            if (jobset, job, unique_packages_enabled, maximum_recursive_file_size) in get_recursive_dependencies_cache:
                ...
                traverse_jobset(hydra, update_progress, report_error, project_name, jobset,
                                lambda job, raw_data: _get_recursive_dependencies(hydra,
                                                                                  raw_data,
                                                                                  _recursive_dependencies_dict, maximum_recursive_file_size), recursive_mode_enabled=True, only_visit_once_enabled=True, progress_bar_enabled=True, whitelist_enabled=True, progress_bar_desc="Getting recursive dependencies", jobs=[job], cancellable=True, unique_packages_enabled=unique_packages_enabled, fowfol=fowfol, gigmi=gigmi)
