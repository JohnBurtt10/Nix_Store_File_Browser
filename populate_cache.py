...
def populate_reverse_dependency_weight_cache(hydra, project, jobsets):
    ...
    for jobset in jobsets:
        ...
        if jobset not in reverse_dependency_weight_cache:
             cache_utils.get_cached_or_compute_reverse_dependency_weight(project, jobset, reverse_dependency_weight_cache, traverse_jobset, hydra, count_descendants)
...
def populate_dependency_weight_cache(hydra, jobsets, project):
    ...
    for jobset in jobsets:
        cache_utils.get_cached_or_compute_dependency_weight(project, jobset, dependency_weight_cache, traverse_jobset, hydra, calculate_dependency_weight)
